...
- '#' is the __comment__ (EXERCISE) sign. It tells R that everything that follows is a comment and R should ignore it. Comments are there to help explain parts of the code that need additional documentation. We will overuse them initially, but reduce this as the course proceeds.
...
389_my_var (starts with a number)

_my_var (start with underline character)

my_var! (contains the ! character which is not allowed)
...
- Only your work until ___23rd of Sept., Monday 1:30 pm___ (EXERCISE) will be considered. 
...
I get an error message while trying to compile the pdf. I previously used LaTeX and I have MikTeX 2.9. The error message I get is: 

! Sorry, but C:\PROGRA~1\MIKTEX~1.9\miktex\bin\x64\xelatex.exe did not succeed.

! The log file hopefully contains the information to get MiKTeX going again:

!   C:/Users/Palotai Veronika/AppData/Local/MiKTeX/2.9/miktex/log/xelatex.log

! You may want to visit the MiKTeX project page, if you need help.

Error: Failed to compile lecture1-slides.tex. See https://yihui.name/tinytex/r/#debugging for debugging tips. See lecture1-slides.log for more info.
Execution halted

The suggested log file says: GUI framework cannot be initialized.
